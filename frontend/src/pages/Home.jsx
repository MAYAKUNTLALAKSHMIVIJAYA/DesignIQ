      ...
      <section className="py-24 px-8 relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 items-center relative z-10">
          ...
          <motion.div {...fadeUp(0.2)} className="flex flex-col gap-8">
            <div className="relative w-full max-w-2xl aspect-video rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-gradient-to-br from-primary/20 to-secondary/20 group">
              <img
                src={HomeHero}
                alt="AI Design Validation"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                onError={(e) => {
                  e.target.style.display = 'none';
                  e.target.parentElement.classList.add('animate-pulse', 'bg-gradient-to-tr', 'from-blue-900', 'to-indigo-900');
                }}
              />
